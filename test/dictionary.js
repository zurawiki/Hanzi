...
describe('hanzidictionary', () => {
  ...
  it('should look up a definition with multiple meanings with a common character', () => {
    const expected = [{
      traditional: '和',
      simplified: '和',
      pinyin: 'He2',
  ...
  it('should look up a definition with multiple meanings with a more obscure character', () => {
    const expected = [{
      traditional: '糺',
      simplified: '糺',
      pinyin: 'jiu1',
  ...
  it('should fail looking up a definition with dirty input', () => {
    assert.deepEqual(hanzi.definitionLookup('%'), undefined);
  });

  it('should do a dictionary search with a common character', () => {
    const expected = [
      [{
        traditional: '六方最密堆積',
        simplified: '六方最密堆积',
  ...
  it('should do a dictionary search and return words with only that entry', () => {
    const expected = [
      [{
        traditional: '爸',
        simplified: '爸',
  ...
  it('should now do a dictionary search with the same character and ignore the only condition', () => {
    const expected = [[{
      traditional: '兔爸',
      simplified: '兔爸',
      pinyin: 'tu4 ba4',
